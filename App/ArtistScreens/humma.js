...
export default class Humma extends Component {
  constructor() {
    super();
    this.state = {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Image
              source={require("../assets/image--003.jpg")}
              style={{
                width: 416,
                height: 250
              }}
            />
            <Image
              source={require("../assets/image--006.jpg")}
              style={{
                width: 416,
                height: 250
              }}
            />
            <Image
              source={require("../assets/image--009.jpg")}
              style={{
                width: 416,
                height: 250
              }}
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.titleText}>
              Humma witness the magic with Maajja{" "}
            </Text>
          </View>
          ...
          <View>
            ...
            >
              ...
              <Text style={styles.matchNo}>94%</Text>
            </View>
            <View
          ...
          <View style={{ flexDirection: "row", marginTop: 10 }}>
            ...
            <View style={{ flexDirection: "column" }}>
              <Text style={styles.listPlace}>Tue, June 14, 2020</Text>
              <Text style={styles.listArea}>06:00PM - 12:00AM</Text>
            </View>
          ...
          <View style={{ flexDirection: "row", marginTop: 20 }}>
            ...
            <View style={{ flexDirection: "column" }}>
              <Text style={styles.listPlace}>YMCA Grounds, Nandanam </Text>
              <Text style={styles.listArea}>Chennai, TamilNadu</Text>
            </View>
          </View>

          <Image
            source={require("../assets/Chennai.png")}
            style={{
              width: 411,
              height: 280,
              marginTop: 20,
          ...
          <View style={{ marginLeft: 15 }}>
            ...
            <Text style={styles.description}>
              India’s premier music festival featuring indie performers from
              India and around the world in a rich live experience.
            </Text>
          </View>
          ...
          <View>
            <ScrollView
              ...
              showsHorizontalScrollIndicator={false}
            >
              <Artist ArtImg={require("../assets/image--012.jpg")} name="ARR" />
              <Artist
                ArtImg={require("../assets/image--015.jpg")}
                name="IMMAN"
              />
              <Artist
                ArtImg={require("../assets/image--018.jpg")}
                name="ANIRUDH"
              />
              <Artist
                ArtImg={require("../assets/image--019.jpg")}
                name="ADHI"
              />
              <Artist
                ArtImg={require("../assets/image--013.jpg")}
                name="ANDREA"
              />
              <Artist
                ArtImg={require("../assets/image--016.jpg")}
                name="SID SRIRAM"
              />
              <Artist ArtImg={require("../assets/image--017.jpg")} name="MIA" />
              <Artist
                ArtImg={require("../assets/image--020.jpg")}
                name="VIDHYA VOX"
              />
              <Artist
                ArtImg={require("../assets/image--021.jpg")}
                name="SHAN"
              />
              <Artist
                ArtImg={require("../assets/image--024.jpg")}
                name="TEEJAY"
              />
            </ScrollView>
          </View>
        ...
        >
          ...
          <TouchableOpacity
            onPress={() => {
              {
                this.onClick();
                this.props.navigation.navigate("EventSignup");
              }
            }}
          >
